...
~/.acme.sh/acme.sh --issue -d nidaoo.xyz --standalone -k ec-256
~/.acme.sh/acme.sh --installcert -d nidaoo.xyz --fullchainpath /usr/local/etc/v2ray/v2ray.crt --keypath /usr/local/etc/v2ray/v2ray.key --ecc
